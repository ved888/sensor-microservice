...
//	freqCh chan time.Duration
//	client pb.SensorServiceClient
//}
//
//func NewGenerator(client pb.SensorServiceClient, freq time.Duration) *Generator {
//	return &Generator{client: client, freqCh: make(chan time.Duration, 1)}
//}
//
...
//		defer cancel()
//		stream, _ := g.client.SendSensorData(ctx)
//
//		for {
//			select {
//			case <-ticker.C:
